...
# are pre-built reusable agent objects. This script demonstrates the PARALLEL
# VOTING ARCHITECTURE PATTERN (independent agents vote; majority wins), not
# agent implementation. See agents/ for what each agent does internally.
...
# vote aggregator LLM. PatientCase is the canonical domain model.
from core.config import get_llm
from core.models import PatientCase
# CONNECTION: observability/ root module — build_callback_config() attaches
# Langfuse tracing to every LLM call across all parallel voting agents.
