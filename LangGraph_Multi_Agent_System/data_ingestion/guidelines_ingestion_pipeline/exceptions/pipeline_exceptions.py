"""
Custom exception hierarchy for the guidelines ingestion pipeline.

All exceptions carry rich context (doc_id, chunk_id, etc.) to enable precise
error tracking and recovery. Each exception provides a human-readable __str__
representation for structured logging.
"""
